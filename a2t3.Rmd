...
All source code, text, figures and data for this project are contained within the GitHub repo at https://github.com/gardiners/a2t3. To get a copy of all of the scripts for marking, please run the following on your AWS Ubuntu server:
